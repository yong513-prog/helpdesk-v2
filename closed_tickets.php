    ...
    function closed_t($key)
    {
        static $dict = [
            'en' => [
                ...
                'sort_title' => 'Title',
                'sort_branch' => 'Branch',
                'sort_department' => 'Person In Charge',
            ...
            'ms' => [
                ...
                'sort_department' => 'Pegawai Bertanggungjawab',
        ...
        <table class="table table-hover closed-table mb-0">
            <thead>
                <tr>
                    ...
                    <th><?= sort_link('department', closed_sort_label('department')); ?></th>
...
<div class="closed-mobile-cards">
    ...
    <div class="closed-mobile-card">
        ...
        <div class="closed-mobile-meta">
            <div><strong><?= h(closed_t('sort_department')) ?></strong><?= h($ticket['department'] ?: '-'); ?></div>
