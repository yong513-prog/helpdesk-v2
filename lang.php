...
function hd_t($text){
    $lang = hd_lang();
    if($text === 'Edit Announcement'){
        $map = [
            'en' => 'Edit Announcement',
            'ms' => 'Edit Pengumuman',
            'zh' => '编辑公告'
        ];
        return $map[$lang] ?? 'Edit Announcement';
    }
    $custom = [
        'en' => [
            ...
            'Administration / Edit Announcement'=>'Administration / Edit Announcement',
            'Communication / Edit Announcement'=>'Communication / Edit Announcement',
            'Update published announcement details.'=>'Update published announcement details.',
            'Announcement Details'=>'Announcement Details',
            'Save changes to the existing announcement.'=>'Save changes to the existing announcement.',
            'Current Attachment'=>'Current Attachment',
            'Remove Attachment'=>'Remove Attachment',
            'Optional. Uploading a new file will replace the current attachment. Max 10MB.'=>'Optional. Uploading a new file will replace the current attachment. Max 10MB.',
...
// Final no-translate / audit-language fixes
        ...
        'ms' => [
            ...
            'Administration / Edit Announcement'=>'Pentadbiran / Edit Pengumuman',
            'Communication / Edit Announcement'=>'Komunikasi / Edit Pengumuman',
            'Update published announcement details.'=>'Kemas kini maklumat pengumuman yang telah diterbitkan.',
            'Announcement Details'=>'Butiran Pengumuman',
            'Save changes to the existing announcement.'=>'Simpan perubahan pada pengumuman sedia ada.',
            'Current Attachment'=>'Lampiran Semasa',
            'Remove Attachment'=>'Buang Lampiran',
            'Optional. Uploading a new file will replace the current attachment. Max 10MB.'=>'Pilihan. Muat naik fail baharu akan menggantikan lampiran semasa. Maksimum 10MB.',
...
'PC'=>'PC','Computer'=>'PC','Komputer'=>'PC','电脑'=>'PC',
        ...
        'zh' => [
            ...
            'Edit announcement'=>'编辑公告',
            'announcement'=>'公告',
            'Administration / Edit Announcement'=>'管理 / 编辑公告',
            'Communication / Edit Announcement'=>'沟通 / 编辑公告',
            'Update published announcement details.'=>'更新已发布公告资料。',
            'Save changes to the existing announcement.'=>'保存对现有公告的修改。',
            'Remove Attachment'=>'删除附件',
            'Optional. Uploading a new file will replace the current attachment. Max 10MB.'=>'可选，上传新文件将替换当前附件，最大 10MB。',
'PC'=>'PC','Computer'=>'PC','Komputer'=>'PC','电脑'=>'PC',
            'No'=>'否','Yes'=>'是',
    ...
    $kpi_v3_custom = [
        'en' => [
            'of Total Tickets'=>'of Total Tickets',
            'Active Ratio'=>'Active Ratio',
            'Closed Ratio'=>'Closed Ratio',
            ...
            'Need triage and assignment'=>'Need triage and assignment',
            ...
            'Top Person In Charge'=>'Top Person In Charge',
            'tickets'=>'tickets',
            'SLA'=>'SLA',
        ],
        'ms' => [
            'of Total Tickets'=>'daripada Jumlah Tiket',
            'Active Ratio'=>'Nisbah Aktif',
            'Closed Ratio'=>'Nisbah Ditutup',
            'Overdue Ratio'=>'Nisbah Lewat',
            'Ticket Status Distribution'=>'Agihan Status Tiket',
            'Trend'=>'Trend',
            'Health'=>'Kesihatan',
            'Excellent'=>'Cemerlang',
            'Warning'=>'Amaran',
            'Critical'=>'Kritikal',
            'Tickets'=>'Tiket',
            'Quick Insights'=>'Ringkasan Pintas',
            'Need triage and assignment'=>'Perlu semakan dan tugasan',
            'Needs Attention'=>'Perlu Perhatian',
            'Requires immediate attention'=>'Memerlukan perhatian segera',
            'Target'=>'Sasaran',
            'Ticket Trend'=>'Trend Tiket',
            'Daily'=>'Harian',
        ...
        'zh' => [
            'of Total Tickets'=>'占总工单',
            'Active Ratio'=>'活跃比例',
            'Closed Ratio'=>'关闭比例',
            'Overdue Ratio'=>'逾期比例',
            'Ticket Status Distribution'=>'工单状态分布',
            'Trend'=>'趋势',
            'Health'=>'健康度',
            'Excellent'=>'良好',
            'Warning'=>'注意',
            ...
            'Tickets'=>'工单',
            'Quick Insights'=>'快速洞察',
            'Need triage and assignment'=>'需要分配和跟进',
            ...
            'Daily'=>'每日',
            'Top Branch'=>'Top 分行',
            'Top Person In Charge'=>'Top 负责人',
            'tickets'=>'工单',
            'SLA'=>'SLA',
        ],
    ];
    foreach($kpi_v3_custom as $kpiLang => $kpiItems){
        if(!isset($custom[$kpiLang])) $custom[$kpiLang] = [];
        $custom[$kpiLang] = array_merge($custom[$kpiLang], $kpiItems);
    }


    // Final small UI-language fixes: SLA badges and audit-log pagination/detail words.
    $small_ui_fixes = [
        'en' => [
            'Due Soon' => 'Due Soon',
            'Overdue' => 'Overdue',
            ...
            'Completed' => 'Completed',
            'Edited announcement' => 'Edited announcement',
            'Edited Announcement' => 'Edited announcement',
        ...
        'ms' => [
            ...
            'Completed' => 'Selesai',
            'Edited announcement' => 'Edit pengumuman',
            'Edited Announcement' => 'Edit pengumuman',
            'Created announcement' => 'Cipta pengumuman',
            'Created Announcement' => 'Cipta pengumuman',
            'announcement' => 'pengumuman',
            'records' => 'rekod',
            'filtered records' => 'rekod ditapis',
            'Previous' => 'Sebelumnya',
            'Next' => 'Seterusnya',
            'Showing' => 'Memaparkan',
            'to' => 'hingga',
        ...
        'zh' => [
            ...
            'Within SLA' => 'SLA内',
            'Completed' => '已完成',
            'Edited announcement' => '编辑公告',
            'Edited Announcement' => '编辑公告',
            'Created announcement' => '创建公告',
            'Created Announcement' => '创建公告',
            'announcement' => '公告',
            'records' => '条记录',
    ...
    foreach($small_ui_fixes as $fixLang => $fixItems){
        if(!isset($custom[$fixLang])) $custom[$fixLang] = [];
        $custom[$fixLang] = array_merge($custom[$fixLang], $fixItems);
    }
