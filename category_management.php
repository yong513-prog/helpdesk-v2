...
@media (max-width: 768px){
  ...
  table.hd-mobile-card-table td:nth-child(2)::before{content:"分类名称";}
  table.hd-mobile-card-table td:nth-child(3)::before{content:"默认优先级";}
...
<div class="master-card">
    ...
    <div class="table-responsive">
        <table class="table table-hover master-table mb-0 hd-mobile-card-table hd-page-category hd-table-category" id="masterTable">
...
<style>@media(max-width:768px){table.hd-mobile-card-table td:nth-child(1)::before{content:"序号";}table.hd-mobile-card-table td:nth-child(2)::before{content:"分类名称";}table.hd-mobile-card-table td:nth-child(3)::before{content:"默认优先级";}table.hd-mobile-card-table td:nth-child(4)::before{content:"状态";}table.hd-mobile-card-table td:nth-child(5)::before{content:"操作";}}</style>
