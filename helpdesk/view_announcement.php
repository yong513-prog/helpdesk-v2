...
<div class="view-wrap">
    <div class="view-head">
        ...
        <div class="d-flex gap-2 flex-wrap">
            <a href="announcements.php" class="btn btn-outline-secondary px-4"><i class="bi bi-arrow-left me-2"></i><?= __('Back') ?></a>
            <?php if($isAdmin): ?>
                <a href="announcement_read_report.php?announcement_id=<?= $announcementId; ?>" class="btn btn-outline-primary px-4"><i class="bi bi-people me-2"></i><?= __('Read Status') ?></a>
            <?php endif; ?>
        </div>
    </div>
