...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="administration.php" class="btn btn-outline-secondary">Back to Administration</a>
</div>
...
<div class="row g-4">
    <div class="col-lg-4">
        <div class="card shadow-sm border-0">
            <div class="card-body">
                <h5 class="mb-3">Add Asset Type</h5>
                <form method="post" action="asset_type_management.php">
                    ...
                    <button type="submit" class="btn btn-primary w-100">Add Asset Type</button>
                </form>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-8">
        <div class="card shadow-sm border-0">
            <div class="card-body">
                <h5 class="mb-3">Asset Type List</h5>
